...
| C2 — inbound signature primitive    | **none**         | 89 runtime exports enumerated (one level into namespaces); 0 matches — the near-misses are the BYO conformance kit; `aws-sigv4` key has `usages: ['sign']`            |
