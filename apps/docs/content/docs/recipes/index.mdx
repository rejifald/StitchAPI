...
<Cards>
    ...
    <Card
        ...
        description="Wrap output with drift to validate against the declared schema — a dropped required field throws, while coercions and undeclared keys surface as non-fatal findings."
    />
    <Card
