...
-   **An AI agent is the caller.** A stitch hands an agent a capability, not a credential, and presents the same definition over MCP that your code calls — without standing up an orchestration service to do it.
