...
declare const card: { number: string; cvc: string };
...
- The request body and the response are truncated to 2048 characters, so a megabyte of PII never becomes a megabyte of log.
