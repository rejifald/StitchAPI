...
-   `retry`: `{ attempts (total incl. first, default 1), on: number|number[]|((status)=>boolean) (default [429,502,503,504]), backoff: 'expo'|'expo-jitter'|'fixed', baseDelay, maxDelay, respectRetryAfter }`
